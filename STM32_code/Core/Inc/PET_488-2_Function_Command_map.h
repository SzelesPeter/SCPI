...
const struct program_mnemonic OUTput_mnemonic = {
    .mnemonic_name = "OUTput",
    .parent = &root_mnemonic,
    .data_types = {NON},
    .function = 0,
    .is_end_mnemonic = false
...
const struct program_mnemonic OUTput_LD1_mnemonic = {
    .mnemonic_name = "LD1",
    .parent = &OUTput_mnemonic,
    .data_types = {DECIMAL_NUMERIC_PROGRAM_DATA, NON},
    .function = &PET_4882_OUTput_LD1,
    .is_end_mnemonic = true
};

const struct program_mnemonic OUTput_LD2_mnemonic = {
    .mnemonic_name = "LD2",
    .parent = &OUTput_mnemonic,
    .data_types = {DECIMAL_NUMERIC_PROGRAM_DATA, NON},
    .function = &PET_4882_OUTput_LD2,
    .is_end_mnemonic = true
};

const struct program_mnemonic OUTput_LD3_mnemonic = {
    .mnemonic_name = "LD3",
    .parent = &OUTput_mnemonic,
    .data_types = {DECIMAL_NUMERIC_PROGRAM_DATA, NON},
    .function = &PET_4882_OUTput_LD3,
    .is_end_mnemonic = true
};
