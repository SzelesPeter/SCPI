...
void PET_4882_Init(PET_488_2* pet_488_2_instance)
{
    ...
    pet_488_2_instance->last_command_root = &pet_488_2_instance->root_mnemonic;
}
...
uint8_t Decode_simple_command_program_header(PET_488_2* pet_488_2_instance, struct program_mnemonic** current_command_root, uint8_t** ptr)
{
    ...
    uint8_t index = 0;
    *current_command_root = &pet_488_2_instance->root_mnemonic; //reset current cooand pointer to root mnemonic
...
uint8_t Decode_decimal_numeric_program_data(uint8_t** ptr, float* output_value)
{
    ...
    if(**ptr == '.') // Read fractional part
    {
        ...
        if(Is_digit(**ptr)) // Read fractional digits
        {
            ...
            while (Is_digit(**ptr))
            {
                mantissa_fraction = mantissa_fraction + ( (**ptr - '0') / power((double)10, (double)(fraction_digit_count + 1)) );
    ...
    *output_value = mantissa * power((double)10, (double)exponent); // Apply exponent to mantissa
    return 0;
}
...
{
	strcpy((char*)&pet_488_2_instance->root_mnemonic.mnemonic_name, ("ROOT"));
	pet_488_2_instance->root_mnemonic.parent = 0;
	memset(pet_488_2_instance->root_mnemonic.data_types, NON, 10);
	pet_488_2_instance->root_mnemonic.function = 0;
	pet_488_2_instance->root_mnemonic.is_end_mnemonic = false;

	strcpy((char*)&pet_488_2_instance->IDN_mnemonic.mnemonic_name, "IDN?");
	pet_488_2_instance->IDN_mnemonic.parent = &pet_488_2_instance->root_mnemonic;
	memset(pet_488_2_instance->IDN_mnemonic.data_types, NON, 10);
	pet_488_2_instance->IDN_mnemonic.function = &PET_4882_IDN_query;
	pet_488_2_instance->IDN_mnemonic.is_end_mnemonic = true;

	strcpy((char*)&pet_488_2_instance->RST_mnemonic.mnemonic_name, "RST");
	pet_488_2_instance->RST_mnemonic.parent = &pet_488_2_instance->root_mnemonic;
	memset(pet_488_2_instance->IDN_mnemonic.data_types, NON, 10);
	pet_488_2_instance->RST_mnemonic.function = &PET_4882_RST_command;
	pet_488_2_instance->RST_mnemonic.is_end_mnemonic = true;

	strcpy((char*)&pet_488_2_instance->SYSTem_mnemonic.mnemonic_name, "SYSTem");
	pet_488_2_instance->SYSTem_mnemonic.parent = &pet_488_2_instance->root_mnemonic;
	memset(pet_488_2_instance->SYSTem_mnemonic.data_types, NON, 10);
	pet_488_2_instance->SYSTem_mnemonic.function = 0;
	pet_488_2_instance->SYSTem_mnemonic.is_end_mnemonic = false;

	strcpy((char*)&pet_488_2_instance->SYSTem_Ld_mnemonic.mnemonic_name, "Ld");
	pet_488_2_instance->SYSTem_Ld_mnemonic.parent = &pet_488_2_instance->SYSTem_mnemonic;
	memset(pet_488_2_instance->SYSTem_Ld_mnemonic.data_types, NON, 10);
	pet_488_2_instance->SYSTem_Ld_mnemonic.data_types[0] = CHARACTER_PROGRAM_DATA;
	pet_488_2_instance->SYSTem_Ld_mnemonic.data_types[1] = CHARACTER_PROGRAM_DATA;
	pet_488_2_instance->SYSTem_Ld_mnemonic.function = &PET_4882_SYSTem_Ld;
	pet_488_2_instance->SYSTem_Ld_mnemonic.is_end_mnemonic = true;

	pet_488_2_instance->common_command_mnemonics[0] = &pet_488_2_instance->IDN_mnemonic;
	pet_488_2_instance->common_command_mnemonics[1] = &pet_488_2_instance->RST_mnemonic;
	pet_488_2_instance->common_command_mnemonics[2] = 0;

	pet_488_2_instance->simple_command_mnemonics[0] = 0;

	pet_488_2_instance->compound_command_mnemonics[0] = &pet_488_2_instance->SYSTem_mnemonic;
	pet_488_2_instance->compound_command_mnemonics[1] = &pet_488_2_instance->SYSTem_Ld_mnemonic;
