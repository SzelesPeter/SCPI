...
HD_PWD='C:/Users/win10/Documents/C/SCPI/FPGA_RISC_V_Test/FPGA_Project/Risc_V_SCPI_FPGA_Test/Risc_V_SCPI_FPGA_Test.runs/main_microblaze_riscv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_microblaze_riscv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_microblaze_riscv_0_0.tcl
